...
class PySelenium(object):
    ...
    def __init__(self, browser='chrome', remoteAddress=None):
        ...
        if remoteAddress is None:
            ...
            if browser == "chrome" or browser == "Chrome":
                ...
                dr = webdriver.PhantomJS(service_log_path='./logs/PhantomJS.log')
            elif browser == "edge":
                dr = webdriver.Edge()
        else:
            if browser == "RChrome":
    ...
    def set_window(self, wide, high):
        ...
        self.my_print("{0} Set browser window wide: {1},high: {2}, Spend {3} seconds".format(success, wide, high, time.time() - t1))
    ...
    def type(self, css, text):
        ...
        try:
            ...
            el.send_keys(text)
            self.my_print("{0} Typed element: <{1}> content: {2}, Spend {3} seconds".format(success, css, text, time.time() - t1))
        except Exception:
            self.my_print("{0} Unable to type element: <{1}> content: {2}, Spend {3} seconds".format(fail, css, text, time.time() - t1))
            raise
    ...
    def clear_type(self, css, text):
        ...
        try:
            ...
            el.clear()
            el.send_keys(text)
            self.my_print("{0} Clear and type element: <{1}> content: {2}, Spend {3} seconds".format(success, css, text, time.time() - t1))
        except Exception:
            self.my_print("{0} Unable to clear and type element: <{1}> content: {2}, Spend {3} seconds".format(fail, css, text, time.time() - t1))
            raise
    ...
    def drag_and_drop(self, el_css, ta_css):
        ...
        try:
            ...
            self.my_print("{0} Drag and drop element: <{1}> to element: <{2}>, Spend {3} seconds".format(success, el_css, ta_css, time.time() - t1))
        except Exception:
            self.my_print("{0} Unable to drag and drop element: <{1}> to element: <{2}>, Spend {3} seconds".format(fail, el_css, ta_css, time.time() - t1))
            raise
    ...
    def forward(self):
        ...
        t1 = time.time()
        self.driver.forward()
        self.my_print("{0} Click forward on current page, Spend {1} seconds".format(success, time.time() - t1))
    ...
    def back(self):
        ...
        t1 = time.time()
        self.driver.back()
        self.my_print("{0} Click back on current page, Spend {1} seconds".format(success, time.time() - t1))
    ...
    def js(self, script):
        ...
        try:
            ...
            self.my_print("{0} Unable to execute javascript scripts: {1}, Spend {2} seconds".format(fail, script, time.time() - t1))
            raise
    ...
    def get_attribute(self, css, attribute):
        ...
        try:
            ...
            self.my_print("{0} Get attribute element: <{1}>,attribute: {2}, Spend {3} seconds".format(success, css, attribute, time.time()-t1))
            return attr
        except Exception:
            self.my_print("{0} Unable to get attribute element: <{1}>,attribute: {2}, Spend {3} seconds".format(fail, css, attribute, time.time() - t1))
            raise
    ...
    def get_title(self):
        ...
        self.my_print("{0} Get current window title {1}, Spend {2} seconds".format(success, title, time.time() - t1))
        return title
    ...
    def wait(self, secs):
        ...
        self.my_print("{0} Set wait all element display in {1} seconds, Spend {2} seconds".format(success, secs, time.time() - t1))
    ...
    def open_new_window(self, css):
        ...
        try:
            ...
            self.my_print("{0} Click element: <{1}> open a new window and swich into, Spend {2} seconds".format(success, css, time.time() - t1))
        except Exception:
            self.my_print("{0} Click element: <{1}> open a new window and swich into, Spend {2} seconds".format(fail, css, time.time() - t1))
            raise
    ...
    def take_screenshot(self):
        ...
        try:
            ...
            self.my_print("{0} Get the current window screenshot,path: {1}, Spend {2} seconds".format(success, file_path, time.time() - t1))
        except Exception:
            self.my_print("{0} Unable to get the current window screenshot,path: {1}, Spend {2} seconds".format(fail, file_path, time.time() - t1))
            raise
    ...
    def js_click(self, css):
        ...
        try:
            ...
            self.my_print("{0} Unable to use javascript click element: {1}, Spend {2} seconds".format(fail, js_str, time.time() - t1))
            raise
    ...
    def assert_text(self, text, path):
        """
        Judgement of specified text

        Usage:
        driver.assert_text(text=' ', path=' ')
        """
        page_text = self.get_text(path)
        #self.my_print(page_text)
        #self.my_print(text)
        try:
            assert text in page_text
            self.my_print("Assertion test pass.")
        except Exception as e:
            self.my_print("Assertion test fail.")
            format(e)
